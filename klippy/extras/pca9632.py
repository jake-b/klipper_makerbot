...
PCA9632DATA = [ 0b00000001,                       # reg0 - responds to all call bus address
            0b00100000 | 0b00010000 | 0b00000100, # reg1 - grp control blink, out inverted, totem pole
            0,                                    # reg2 - led0
            0,                                    # reg3 - led1
            0,                                    # reg4 - led2
            0,                                    # reg5 - led3
            ...
            0b10101010]                           # reg8 - led control (set all 4
                                                  #        to individual pwm control)

BACKGROUND_PRIORITY_CLOCK = 0x7fffffff00000000

#todo - need to map between these colors and the proper registers
#   replicator  flashforge
#2  blue        red
#3  green       blue
#4  red         green
#5  n/a         white?
...
class PCA9632:
    def __init__(self, config):
        ...
        self.led2 = int(red * 255. + .5)
        self.led1 = int(green * 255. + .5)
        self.led0 = int(blue * 255. + .5)
        self.led3 = int(white * 255. + .5)
        self.led_blink = int(blink * 255. + .5)        
        # Register commands
    ...
    def send_data(self, print_time=None):
        ...
        if self.led_blink > 0:
            data[8] = 0b11111111 # reg8 - led control (set all to individual pwm 
            #                             and group blink control)
        else:
            data[8] = 0b10101010 # reg8 - led control (set all to individual pwm 
            #                             and no blink)
        self.i2c.i2c_write((PCA9632CONTROL + data), minclock=minclock,
                          reqclock=BACKGROUND_PRIORITY_CLOCK)
    cmd_SET_LED_help = "Set the color of an LED.  SET_LED LED=my_pca9632 RED=0.1 GREEN=0.1 BLUE=0.1 WHITE=0.1 BLINK=0.5"
